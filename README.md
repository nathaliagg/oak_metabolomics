...
- [3 - Summary of analysis pipeline](#3---summary-of-analysis-pipeline)  
        ...
        [3 - MS2 Annotation with GNPS and SIRIUS](#3---ms2-annotation-with-gnps-and-sirius)   
        [4 - Multivariate Analyses](#4---multivariate-analysis)  
        [5 - Gene-metabolite integration with MAGI](#5---gene-metabolite-integration-with-magi)  
